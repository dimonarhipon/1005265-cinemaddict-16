...
const createSortFilms = (currentFilmsSortType) => `<ul class="sort">
  <li>
    <a href="#"
      class="sort__button ${currentFilmsSortType === SortType.DEFAULT ? 'sort__button--active' : ''}"
      data-sort-type="${SortType.DEFAULT}">Sort by default</a>
  </li>
  <li>
    <a href="#"
      class="sort__button ${currentFilmsSortType === SortType.DATE ? 'sort__button--active' : ''}"
      data-sort-type="${SortType.DATE}">Sort by date</a>
  </li>
  <li>
    <a href="#"
      class="sort__button ${currentFilmsSortType === SortType.RATING ? 'sort__button--active' : ''}"
